...
//RINGER_SWITCH_T RINGER_SWITCH;
//uint32_t window_accumulation;
//const int DFC_ACCUMULATION_SIZE;
//uint64_t dfc_accumulation;
//const int NUM_RANDOM_MULTIPLIERS = 100;
//uint16_t random_multiplier[];
//int random_multipler_idx;
/****************************************************/
#endif
